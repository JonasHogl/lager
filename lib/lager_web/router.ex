defmodule LagerWeb.Router do
  ...
  scope "/", LagerWeb do
    ...
    live_session :redirect_if_user_is_authenticated,
      on_mount: [{LagerWeb.UserAuth, :redirect_if_user_is_authenticated}] do
  ...
  scope "/", LagerWeb do
    ...
    live_session :require_authenticated_user,
      on_mount: [{LagerWeb.UserAuth, :ensure_authenticated}] do
  ...
  scope "/", LagerWeb do
    ...
    live_session :current_user,
      on_mount: [{LagerWeb.UserAuth, :mount_current_user}] do
